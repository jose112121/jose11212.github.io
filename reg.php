...
<body>
	...
	<?php
	$username = $_POST['username']; // Asegúrate de obtener el valor correcto desde el formulario
	$query = "SELECT * FROM user_info WHERE UserName = '$username'";
	$result = mysqli_query($strconn, $query);

	if (mysqli_num_rows($result) > 0) {
		// El nombre de usuario ya existe, muestra un mensaje de error o toma una acción
		echo "El nombre de usuario ya está en uso.";
	} else {
		// Puedes proceder con la inserción en la base de datos
		// ...
	}
